...
if __name__ == '__main__':
  ...
  function_id, model_type = sys.argv[1:3]
  ###########################################################
  ### plot experiment 1 : simple functions
  ROOT_DIR = os.path.join('logs', 'simple_functions', model_type)
  ...
  if function_id == 'nn_constant':
    save_key_plot(ROOT_DIR, plot_dir, function_id=function_id, model_ids=model_ids_plot, key='val_losses/unnormalized_mse_mean', ymin=6.0, ymax=8.5)
    save_key_plot(ROOT_DIR, plot_dir, function_id=function_id, model_ids=model_ids_plot, key='val_losses/unnormalized_nll', ymin=0.0, ymax=5.0)
    save_key_plot(ROOT_DIR, plot_dir, function_id=function_id, model_ids=model_ids_plot, key='val_addmetrics/cov_w2', ymin=-1.0, ymax=15.0)
